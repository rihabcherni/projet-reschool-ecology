...
export default function MapResponsable() {
  ...
  return (
    <div style={{display:"flex", justifyContent:"space-between"}}>    
      <GoogleMap mapContainerStyle={containerStyle} onClick={() =>{ setActiveMarkerEtablissement(null); setUniqueEtablissements(null) ;setShowUniqueEtablissement(true);setActiveMarkerCamion(null); setUniqueCamions(null) ;setShowUniqueCamion(true);}} center={center} zoom={10}>                  
