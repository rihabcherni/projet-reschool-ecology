      ...
      return (
        <>    
            {profile.photo===null?
              ...
              <img src={`https://reschoolecology.tech/storage/images/gestionnaire/${profile.photo}`} style={{margin:"2% 18%" , borderRadius:"50%", width:"200px", height:"200px"}} alt="gestionniare image"/>
            } 
