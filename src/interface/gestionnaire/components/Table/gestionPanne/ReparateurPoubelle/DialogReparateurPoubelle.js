...
export default function DialogReparateurPoubelle({open,handleClose,data,onChange,handleFormSubmit}) {
  ...
  return (
    <div>
      ...
      >
        <DialogTitle id="alert-dialog-title">{id?"modifier reparateur poubelle":"créer un nouveau reparateur poubelle"}</DialogTitle>
        <DialogContent>
         <form>
